...
public class CountryPartitioner implements Partitioner {
	...
	// This method will gets called at the start, you should use it to do one
	// time startup activity
	...
	public int partition(String topic, Object key, byte[] keyBytes, Object value, byte[] valueBytes, Cluster cluster) {
		...
		if (countryToPartitionMap.containsKey(key.toString())) {
			// If the country is mapped to particular partition return it
			return countryToPartitionMap.get(key.toString());
		} else {
